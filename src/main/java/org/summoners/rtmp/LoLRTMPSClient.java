...
public class LoLRTMPSClient extends RTMPSClient {
    ...
    public LoLRTMPSClient(ServerInfo serverInfo, String clientVersion, String user, String pass) {
        ...
        this.region = serverInfo.getRegion();
        this.server = serverInfo.getServer();
        this.loginQueue = serverInfo.getLoginQueue();
        this.useGarena = serverInfo.isUseGarena();
    ...
    public void login() throws IOException {
        ...
        //LoginScreen.setProgressText("Connected to " + region);
    }
    ...
    private void getAuthToken() throws IOException {
        ...
        try {
        	...
        	//if (msg.contains("403"))
        		//LoginScreen.setErrorText("Invalid username/password combination. Please try again.    "
        		//		+ "                                                     "
        		//		+ "If you're still having issues, click \"Forgot your password?\"");
            return;
        }
        ...
        if (!result.containsKey("token")) {
            ...
            // Let the user know
            //LoginScreen.setProgressText("In login queue for " + region + ", #" + (id - cur) + " in line");
            ...
            while (id - cur > rate) {
                ...
                //LoginScreen.setProgressText("In login queue for " + region + ", #" + (int)Math.max(1, id - cur) + " in line");
            }
